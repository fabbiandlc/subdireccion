...
function ActivityForm({ setModalVisible, editIndex, setEditIndex }) {
  ...
  const handleSave = () => {
    ...
    const newActivity = {
      ...
      notes: filteredNotes,
      createdAt: editIndex !== null ? activities[editIndex].createdAt : new Date().toISOString(),
      ...
      case "checklist":
        return (
          <View key={note.id} style={styles.checklistContainer}>
            ...
            />
            <TouchableOpacity onPress={() => updateNote(note.id, note.content, !note.completed)}>
              <Text style={[styles.checkboxText, note.completed && styles.completed]}>
                {note.completed ? "✓" : "○"}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => removeNote(note.id)}>
        ...
        >
          ...
          <View style={styles.notesSection}>
            ...
            <View style={styles.addButtonsContainer}>
              <TouchableOpacity style={[styles.addButton, styles.textButton]} onPress={() => addNote("text")}>
                <Text style={styles.addButtonText}>+ Nota</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.addButton, styles.checklistButton]} onPress={() => addNote("checklist")}>
